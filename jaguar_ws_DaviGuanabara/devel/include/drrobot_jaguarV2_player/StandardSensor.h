// Generated by gencpp from file drrobot_jaguarV2_player/StandardSensor.msg
// DO NOT EDIT!


#ifndef DRROBOT_JAGUARV2_PLAYER_MESSAGE_STANDARDSENSOR_H
#define DRROBOT_JAGUARV2_PLAYER_MESSAGE_STANDARDSENSOR_H
...
struct StandardSensor_
{
  ...
  typedef boost::shared_ptr< ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator> const> ConstPtr;

}; // struct StandardSensor_

typedef ::drrobot_jaguarV2_player::StandardSensor_<std::allocator<void> > StandardSensor;

typedef boost::shared_ptr< ::drrobot_jaguarV2_player::StandardSensor > StandardSensorPtr;
typedef boost::shared_ptr< ::drrobot_jaguarV2_player::StandardSensor const> StandardSensorConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator> >
{
  ...
  static const char* value(const ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe867c61af4cf7799ULL;
  static const uint64_t static_value2 = 0x89629edb31d6fbd8ULL;
};

template<class ContainerAllocator>
struct DataType< ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::drrobot_jaguarV2_player::StandardSensor_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // DRROBOT_JAGUARV2_PLAYER_MESSAGE_STANDARDSENSOR_H
