...
"""autogenerated by genpy from drrobot_jaguarV2_player/MotorInfoArray.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import drrobot_jaguarV2_player.msg
import std_msgs.msg

class MotorInfoArray(genpy.Message):
  _md5sum = "64d8eb9826ec2f78779f54df29bcc931"
  _type = "drrobot_jaguarV2_player/MotorInfoArray"
...
"""
  ...
  _slot_types = ['drrobot_jaguarV2_player/MotorInfo[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = drrobot_jaguarV2_player.msg.MotorInfo()
        _v3 = val1.header
        start = end
        end += 4
