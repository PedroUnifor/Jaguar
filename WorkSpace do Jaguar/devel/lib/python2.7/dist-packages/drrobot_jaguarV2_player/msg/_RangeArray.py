...
"""autogenerated by genpy from drrobot_jaguarV2_player/RangeArray.msg. Do not edit."""
import sys
...
class RangeArray(genpy.Message):
  ...
  _type = "drrobot_jaguarV2_player/RangeArray"
...
"""
  __slots__ = ['ranges']
  _slot_types = ['drrobot_jaguarV2_player/Range[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = drrobot_jaguarV2_player.msg.Range()
        _v3 = val1.header
        start = end
        end += 4
