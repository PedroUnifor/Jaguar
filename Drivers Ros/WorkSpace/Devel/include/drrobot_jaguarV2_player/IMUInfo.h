// Generated by gencpp from file drrobot_jaguarV2_player/IMUInfo.msg
// DO NOT EDIT!


#ifndef DRROBOT_JAGUARV2_PLAYER_MESSAGE_IMUINFO_H
#define DRROBOT_JAGUARV2_PLAYER_MESSAGE_IMUINFO_H
...
struct IMUInfo_
{
  ...
  typedef boost::shared_ptr< ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator> const> ConstPtr;

}; // struct IMUInfo_

typedef ::drrobot_jaguarV2_player::IMUInfo_<std::allocator<void> > IMUInfo;

typedef boost::shared_ptr< ::drrobot_jaguarV2_player::IMUInfo > IMUInfoPtr;
typedef boost::shared_ptr< ::drrobot_jaguarV2_player::IMUInfo const> IMUInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x701e9d1318413bd1ULL;
  static const uint64_t static_value2 = 0xe8936e4896f37226ULL;
};

template<class ContainerAllocator>
struct DataType< ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::drrobot_jaguarV2_player::IMUInfo_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // DRROBOT_JAGUARV2_PLAYER_MESSAGE_IMUINFO_H
