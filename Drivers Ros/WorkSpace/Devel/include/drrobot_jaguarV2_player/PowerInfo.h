// Generated by gencpp from file drrobot_jaguarV2_player/PowerInfo.msg
// DO NOT EDIT!


#ifndef DRROBOT_JAGUARV2_PLAYER_MESSAGE_POWERINFO_H
#define DRROBOT_JAGUARV2_PLAYER_MESSAGE_POWERINFO_H
...
struct PowerInfo_
{
  ...
  typedef boost::shared_ptr< ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator> const> ConstPtr;

}; // struct PowerInfo_

typedef ::drrobot_jaguarV2_player::PowerInfo_<std::allocator<void> > PowerInfo;

typedef boost::shared_ptr< ::drrobot_jaguarV2_player::PowerInfo > PowerInfoPtr;
typedef boost::shared_ptr< ::drrobot_jaguarV2_player::PowerInfo const> PowerInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x13107d877ae888e7ULL;
  static const uint64_t static_value2 = 0x541f720d1432d852ULL;
};

template<class ContainerAllocator>
struct DataType< ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::drrobot_jaguarV2_player::PowerInfo_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // DRROBOT_JAGUARV2_PLAYER_MESSAGE_POWERINFO_H
